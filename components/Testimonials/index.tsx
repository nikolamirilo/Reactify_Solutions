...
const Testimonials: any = async () => {
  ...
  if (testimonials)
    return (
      <section
        className="bg-primaryColor/[.03] relative z-10 mt-16 border-t border-textColor/[.15] py-16 pb-16 dark:border-white/[.15] md:py-20 md:pb-20 lg:py-28 lg:pb-28"
        id="testimonials"
      >
        <div className="container relative">
          ...
          {testimonials.length < 1 && (
            <div className="mx-auto w-full text-center text-base !leading-relaxed text-textColor md:text-lg">
              There are currently no testimonials. Be first one to add it!
            </div>
          )}
